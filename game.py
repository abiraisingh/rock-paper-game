...
#picture
rock_img = ImageTk.PhotoImage(Image.open("rock-image3.png"))
paper_img = ImageTk.PhotoImage(Image.open("paper-image1.png"))
scissor_img = ImageTk.PhotoImage(Image.open("scissor-image2.png"))
rock_img_comp = ImageTk.PhotoImage(Image.open("rock-image3.png"))
paper_img_comp = ImageTk.PhotoImage(Image.open("paper-image1.png"))
scissor_img_comp = ImageTk.PhotoImage(Image.open("scissor-image2.png"))
